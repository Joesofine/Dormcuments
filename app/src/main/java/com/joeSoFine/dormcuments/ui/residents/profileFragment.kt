...
class profileFragment : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val expandableFab = view.findViewById<ExpandableFab>(R.id.fab)

        var efabIcon = ContextCompat.getDrawable(requireContext(), R.drawable.ic_baseline_settings_24)
            fab.setImageDrawable(efabIcon)
